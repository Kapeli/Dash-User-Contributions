...
## Description
The 9.6.3 rc1 release of LC has a few dictionary updates. This version of the documentation includes these updates.
...
The current version(1.8.0) has been compiled from the 9.6.3 rc1 using "Make docset V3.6" (see below)
...
### Note
The current docset version was ran against LC 9.6.3rc1
