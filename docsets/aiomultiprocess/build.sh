...
mv aiomultiprocess.tgz aiomultiprocess.tgz.txt
mv versions/$AIOMULTIPROCESS_VERSION/aiomultiprocess.tgz versions/$AIOMULTIPROCESS_VERSION/aiomultiprocess.tgz.txt
