...
The Docset was generated with the [Elm Docset Generator](https://github.com/kraklin/elm-docset) on 2020-04-10 using the JSON data from http://package.elm-lang.org/
...
There are two versions of the documentation: 
  ...
  * `^0.19.0` current version of packages as of 2020-04-10
